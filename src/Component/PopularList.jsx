    ...
    if (error) {
      ...
      if (posts.length > 0){
        ...
        <div className="posts">
            ...
            {posts.map(post => (
            <Post key={post.id} post={post} type={this.props.type} loadPosts={this.loadPosts} username={post.author.username} userid={post.author.id} source='popular' blockedUsers={this.state.blockedUsers}/>
            ))}
